package cn.cyq.infrastructure.redis;
...
public interface IRedisService {
    ...
    default int getIndexFromUserId2(String userId) {
        // 使用MurmurHash3，输出32位哈希值
        int hash = Hashing.murmur3_32().hashString(userId, StandardCharsets.UTF_8).asInt();
        // 取绝对值并限制范围
